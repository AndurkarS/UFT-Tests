...
namespace Script
{
    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_StServiceCallActivity4_checkpoints(STActivityBase activity)
        {
            ...
            // Checkpoint 2
            IVTDGetter actualValueGetter2 = new VTDXPathGetter(new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][1]/*[local-name(.)='ArrivalCity'][1]"), XmlTypeCode.String, false);
            ...
            CpValObj valueExpectedObject2 = new CpValObj("Frankfurt", XmlTypeCode.String);
            ValueCPRule cpRule2 = new ValueCPRule(valueActualObject2, valueExpectedObject2, StringCP.EqualTo, "=", false);

            // Checkpoint 3
            IVTDGetter actualValueGetter3 = new VTDXPathGetter(new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][1]/*[local-name(.)='DepartureCity'][1]"), XmlTypeCode.String, false);
            ...
            CpValObj valueExpectedObject3 = new CpValObj("Denver", XmlTypeCode.String);
